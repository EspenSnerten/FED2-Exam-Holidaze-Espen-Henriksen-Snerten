...
export default function CreateVenue() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data) {
        document.getElementById("post_created_modal").showModal();
  ...
  return (
    <div className="flex flex-col p-2">
      <div className="flex flex-row gap-2.5">
        <h2 className="text-[20px] font-medium my-auto">Create a venue</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <dialog id="post_created_modal" className="modal">
          <div className="text-center p-14 modal-box primary-clr4 w-fit">
            <h3 className="mb-4 font-bold text-md">Venue posted!</h3>
            <FontAwesomeIcon
              icon={faCheck}
