...
export default function HeaderWithBg() {
  ...
  return (
    <>
      <header className="w-full px-0 pt-0">
        <nav className="max-w-[1150px] w-full flex flex-row mx-auto  header-bg py-4 px-4 lg:rounded-b-xl">
